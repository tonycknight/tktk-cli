namespace Tk.Toolkit.Cli.Waffle
{
    internal class PhraseProvider : IPhraseProvider
    {
        private static readonly string[] PreamblePhrases = new[]
        {
                ...
                "Without a doubt, |f |s was right in saying that",
        ...
        private static readonly string[] Verbs = new[]
            {
                ...
                "interprets","reflects","evinces","expresses","indicates",
                "manifests","reveals","shows","represents","anticipates","denotes",
        ...
        private static readonly string[] SecondAdjectivePhrases = new[]
            {
                ...
                "precise","cardinal",
                "affirming","harmonizing","central","essential","primary","indicative",
                ...
                "non-referent","overriding","politico-strategical","economico-social","on-going",
                "extrinsic","intrinsic","effective","prime","major","empirical","definitive",
